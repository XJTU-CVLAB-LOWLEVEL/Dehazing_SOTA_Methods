...
if category == 'indoor':
    ...
    val_data_dir = './data/VideoHazy_v3/test/'
...
old_val_psnr, old_val_ssim = validation(net, val_data_loader, device, category)#, old_val_ssim
...
for epoch in range(num_epochs):
    ...
    if epoch%5==4:
        ...
        val_psnr, val_ssim  = validation(net, val_data_loader, device, category) #, val_ssim
