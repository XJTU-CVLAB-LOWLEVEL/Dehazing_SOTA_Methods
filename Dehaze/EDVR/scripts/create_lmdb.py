...
def create_lmdb_for_div2k():
    ...
    """
    # HR images
    folder_path = '/home/yzt/EDVR/datasets/DIV2K/DIV2K_train_HR_sub'
    lmdb_path = '/home/yzt/EDVR/datasets/DIV2K/DIV2K_train_HR_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx2 images
    folder_path = '/home/yzt/EDVR/datasets/DIV2K/DIV2K_train_LR_bicubic/X2_sub'
    lmdb_path = '/home/yzt/EDVR/datasets/DIV2K/DIV2K_train_LR_bicubic_X2_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx3 images
    folder_path = '/home/yzt/EDVR/datasets/DIV2K/DIV2K_train_LR_bicubic/X3_sub'
    lmdb_path = '/home/yzt/EDVR/datasets/DIV2K/DIV2K_train_LR_bicubic_X3_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx4 images
    folder_path = '/home/yzt/EDVR/datasets/DIV2K/DIV2K_train_LR_bicubic/X4_sub'
    lmdb_path = '/home/yzt/EDVR/datasets/DIV2K/DIV2K_train_LR_bicubic_X4_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
...
def create_lmdb_for_reds():
    ...
    """
    # train_sharp
    folder_path = '/home/yzt/EDVR/datasets/VideoHazy_v2_re/Train/lr'
    lmdb_path = '/home/yzt/EDVR/datasets/VideoHazy_v2_re/train_lr.lmdb'
    img_path_list, keys = prepare_keys_reds(folder_path)
    make_lmdb_from_imgs(
        folder_path, lmdb_path, img_path_list, keys, multiprocessing_read=True)

    # train_sharp_bicubic
    folder_path = '/home/yzt/EDVR/datasets/VideoHazy_v2_re/Train/gt'
    lmdb_path = '/home/yzt/EDVR/datasets/VideoHazy_v2_re/train_gt.lmdb'
    img_path_list, keys = prepare_keys_reds(folder_path)
    make_lmdb_from_imgs(
        folder_path, lmdb_path, img_path_list, keys, multiprocessing_read=True)
...
def prepare_keys_reds(folder_path):
    ...
    print('Reading image path list ...')
    img_path_list = sorted(
        list(mmcv.scandir(folder_path, suffix='JPG', recursive=True)))
