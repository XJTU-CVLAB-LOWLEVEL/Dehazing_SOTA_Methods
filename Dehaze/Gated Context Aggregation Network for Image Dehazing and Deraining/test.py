...
parser.add_argument('--indir', default='examples/test/haze')
...
opt.model = 'checkpoint/default_exp/gca_model.pth'
...
for img_path in test_img_paths:
    ...
    out_img.save(os.path.join(opt.outdir, os.path.splitext(os.path.basename(img_path))[0] + '_%s.JPG' % opt.task))
