...
class Options:
    ...
    def __init__(self):
        ...
        # Optional argument
        parser.add_argument('--dataset', required=False, default='dataset', help='Name of the dataset')

        # Semantic models
        parser.add_argument('--model-name', nargs='+', default=['teacher', 'student'],type=str, help='Distilled Model')
        parser.add_argument('--model-name2', default='teacher',type=str, help='Distilled Model')

        # Weight (on loss) parameters
        parser.add_argument('--lambda-p', default=1, type=float, help='Weight on the perceptual loss')
        parser.add_argument('--lambda-rm', default=1, type=float, help='Weight on the reconstruction loss')
        # model parameters
        parser.add_argument('--batch-size', default=4, type=int, help='Batch size of Train')
        parser.add_argument('--batch-size2', default=1, type=int, help='Batch size of Test')
        ...
        parser.add_argument('--load-best-model', action='store_false', default=False, help='Load the model weight from given path.')
        ...
        parser.add_argument("--best-model-path", type=str, default="", help="Best model path to be loaded.")
        parser.add_argument("--best-teacher-model-path", type=str, default="", help="Best teacher model path to be loaded.")

        # Checkpoint parameters
        parser.add_argument('--test', action='store_false', default=False, help='Test only flag')
